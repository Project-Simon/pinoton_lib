...
#include <pinotonlib/output/circular_output.hpp>
#include <pinotonlib/output/file_output.hpp>
#include <pinotonlib/output/net_output.hpp>
#include <pinotonlib/output/output.hpp>
