...
#include <pinotonlib/encoder/encoder.hpp>
#include <pinotonlib/encoder/h264_encoder.hpp>
#include <pinotonlib/encoder/mjpeg_encoder.hpp>
#include <pinotonlib/encoder/null_encoder.hpp>

#if LIBAV_PRESENT
#include <pinotonlib/encoder/libav_encoder.hpp>
#endif
